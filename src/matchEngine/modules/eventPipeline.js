...
const G = createEngineModule({ id: 'module-g-performance-ratings', name: 'Module G — Player Performance Ratings', order: 7, constitution: 'Match Engine Constitution v0.3; Appendix E v0.1', execute: executePerformanceRatings });
