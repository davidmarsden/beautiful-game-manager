...
const REPLAY_EVENT_PRESENTATIONS = Object.freeze({
  ...
  yellow_card: Object.freeze({ importance: 'featured', major: false, featured: true, kind: 'booking', label: 'YELLOW CARD', hold_ms: 1200, priority: 45 }),
  free_kick: Object.freeze({ importance: 'featured', major: false, featured: true, kind: 'set_piece', label: 'FREE KICK', hold_ms: 1000, priority: 35 }),
  save: Object.freeze({ importance: 'featured', major: false, featured: true, kind: 'save', label: 'SAVE', hold_ms: 1100, priority: 34 }),
  injury: Object.freeze({ importance: 'featured', major: false, featured: true, kind: 'injury', label: 'INJURY', hold_ms: 1400, priority: 33 }),
  substitution: Object.freeze({ importance: 'featured', major: false, featured: true, kind: 'substitution', label: 'SUBSTITUTION', hold_ms: 1000, priority: 25 })
});
